...
[Download v3.0.0](https://github.com/bensonmaxai/line-desktop-mcp/releases/tag/v3.0.0) · [Release notes](releases/v3.0.0.en.md) · [Install](quickstart-windows.md) · [Technical contract](windows-extensions.md)
